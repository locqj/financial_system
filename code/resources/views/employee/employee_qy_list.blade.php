...
<section class="panel panel-default">
    <div class="table-responsive" >
        ...
        <table class="table table-striped b-t b-light text-sm">
            <tr>
                <th>
                    <label class="labelStyle">区域名称</label>
        ...
        <tbody>
            @foreach($lists as $list)
                <tr id="{{ $list->employee_code }}">                     
                    ...
                    <button class="btn btn-sm btn-default operate" onclick="del('{{ $list->employee_code }}')" onmouseover="this.style.backgroundColor='#33C1A4'; this.style.color = 'white';" onmouseout="this.style.backgroundColor = '#17c5cb';this.style.color = 'white';">删除</button>
                    @endif
                  </td>                    
                </tr>
            @endforeach
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <tr>                      
                <td class="td4">手机号</td>
                <td><input type="text" class="i3" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" maxlength="11" id="phone"/></td>
            </tr>
            <tr>                      
                <td class="td4">身份证号</td>
                <td><input value="" class="i3" maxlength="18"  type="text" onkeyup="value=value.replace(/^[a-zA-Z]+\D*|^\d{0,16}[a-zA-Z]+|[^0-9Xx]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" id="id_card"></td>
            </tr>
            <tr>                      
...
/*        $('#cancel').click(function(event) {
        ...
        $.get('/getposition/'+store_code, function(data) {
            if(data.status == 1){
                ...
                $.each(data.data, function(key, val) {
                    ...
                    var code = val.code;
                    $(clo).attr('value', code);
                    if (code.substr(0, 2) == 'xs') {
                        var name = val.name+"["+val.level+"]";
                    }else{
                        var name = val.name;
                    }
                    $(clo).text(name);
    ...
    function searchEmployee(){
        ...
        window.location.href = '/searchemployee/employee/'+name;
    }
</script>
@endsection