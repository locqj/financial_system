...
@section('content')
                ...
                <table class="headerStyle">
                    <tr>
                      ...
                      @if(in_array(session::get('level_code'), ['cw']))
                        <button class="btn btn-sm btn-default addNew" data-toggle="modal" id="storeAdd" data-target="#modifyStore" onmouseover="this.style.backgroundColor='#33C1A4'; this.style.color = 'white';" onmouseout="this.style.backgroundColor = '#17c5cb';this.style.color = 'white';" onclick="cAdd();">添加地域</button>
                      @endif
                      </th>
                    </tr>
                </table>
                ...
                <div class="modal-body">
                  <div class="table-responsive">
                    <table class="table" id="edittable">                
                              ...
                              <tr id="storeCodeTr">                     
                                <td class="modalTd">地域编码</td>
                                <td id="storeCode"></td>
                              </tr>
                                <td class="modalTd">地域名称</td>
          ...
          <script type="text/javascript">
            ...
            function cUpdate(id){
                ...
                $.get('/city/find/'+id, function(data) {
